...
module.exports.addProduct = async (req,res)=>{
    ...
    res.render('products/addProduct', { category: category, subcategory: subcategory})
}
...
module.exports.viewProducts = async (req,res)=>{
    const data = await productSchema.find({}).populate('categoryId').populate('subcategoryId')
    console.log(data);  
    res.render('products/viewProducts',{data})
}
